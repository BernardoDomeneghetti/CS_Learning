...
namespace ByteBankWebMVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ICurrentAccountFactory, CurrentAccountFactory>();

            services.AddSingleton(typeof(Dictionary<int, Customer>));
            services.AddSingleton(typeof(Dictionary<int, CurrentAccount>));
        }
